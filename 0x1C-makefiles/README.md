# C - Makefiles
In this project, I honed my skills in writing Makefiles, a build automation tool
used for managing dependencies and compiling code.

* [test](./test): Folder that consist of a test file provided by ALX SE School.

## Utility Files provided by ALX SE School

* [school.c](./school.c): C function that displays a seahorse in text.
Used for Makefile practice purposes throughout project.

* [main.c](./main.c): Entry point of the code defined in [school.c](./school.c).
